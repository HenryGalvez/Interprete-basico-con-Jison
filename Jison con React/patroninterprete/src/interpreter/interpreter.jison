%{
     ...
     Codigo JS
     */
     const Logical = require('./classes/Logical');
     //import Logical from './classes/Logical';
     const Relational = require('./classes/Relational');
     const Arithmetical = require('./classes/Arithmetical');
     const Value = require('./classes/Value');
     const Print = require('./classes/Print');
     const Declaration = require('./classes/Declaration');
     const IfList = require('./classes/IfList');
     const Else = require('./classes/Else');
     const If = require('./classes/If');
     const While = require('./classes/While');
     const DoWhile = require('./classes/DoWhile');
     const Assignment = require('./classes/Assignment');
     const For = require('./classes/For');
     const Unary = require('./classes/Unary');
	const Type = require('./classes/Type');
     const Count = require('./classes/Counters');
     const SymbolTable = require('./classes/SymbolTable');
	const Call = require('./classes/Call');
...
IF
     :  CELSE ELSE {let t = $1;t.elsebody = $2;$$ = t;}
;

CELSE
     : CELSE reselse IFF {$$ = $1; $$.lif.push($3);}
     | IFF {$$ = new IfList(); $$.lif.push($1);}
;
